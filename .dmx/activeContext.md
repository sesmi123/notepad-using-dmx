...
## Open Decisions
- Language/framework for the notes API is not chosen (FastAPI, Flask, Express, etc.).
- Persistence technology is not chosen (SQLite is the likely simplest local option).
