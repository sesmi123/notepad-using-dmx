...
- [x] Add `tests/` using pytest + FastAPI TestClient against an isolated SQLite file
- [x] Cover create/read/list/update/delete, 404s, validation failures (no data change), and persistence across a reconnect
- [x] Write `README.md` with install/run/test commands, endpoints, request/response shapes, and validation rules
